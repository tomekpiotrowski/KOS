...
{
    public class ConfigNodeFormatter : Formatter
    {
        private const string PARENT_NODE = "";
        ...
        public Dump Read(string input)
        {
            ...
            return FromConfigNode(configNode.GetNode(PARENT_NODE));
        }
    }
}

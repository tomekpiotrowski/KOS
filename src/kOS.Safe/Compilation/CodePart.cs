...
namespace kOS.Safe.Compilation
{
    public class CodePart
    {
        ...
        public void AssignSourcePath(GlobalPath filePath)
        {
        ...
        private void AssignSourcePathToSection(GlobalPath filePath, IEnumerable<Opcode> section)
        {
            ...
            {
                opcode.SourcePath = filePath; // Intern ensures we don't waste space storing the filename again and again per opcode.
            }
        }

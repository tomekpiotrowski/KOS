...
namespace kOS.Safe.Compilation.KS
{
    ...
    public partial class Scanner
    {
        ...
        public Scanner()
        {
            ...
            regex = new Regex(@"(?i)\bmove\b");
            Patterns.Add(TokenType.MOVE, regex);
            Tokens.Add(TokenType.MOVE);

            regex = new Regex(@"(?i)\bcd\b");
            Patterns.Add(TokenType.CD, regex);
            Tokens.Add(TokenType.CD);
